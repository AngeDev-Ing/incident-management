...
<head>
    ...
    <title>Digital Sentinel - Reportes de Operación</title>
...
<aside class="sidebar bg-dark text-white d-flex flex-column shadow">
    ...
    <ul class="nav nav-pills flex-column mb-auto px-3 gap-1">
        ...
        <li>
            <a href="/reportes" class="nav-link text-white active bg-primary bg-opacity-25 d-flex align-items-center gap-3">
                <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">assessment</span> Reportes
            </a>
        </li>
        <li>
    ...
    <div class="p-4 mt-auto border-top border-secondary">
        ...
        <div class="d-flex align-items-center gap-3 bg-secondary bg-opacity-25 p-2 rounded">
            <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuDTSOQplPzIQoPix90E1RI_gAAY8bdA0gE0fBB4fqYjCWhOZSX977kI-ES-bD-6rGftqsEjqdrmOrA_NRUgNfuD6lO2O9W4lmLHwCznHcGVSgYP8-u_i4fhNRD9IEnqg2SHuG6uZ1rys9lp6Pz8Yt27JYVTZvvpgqERHFHGHCYB_XHWnhCgsVxFSEKA60htUdHYf9VYOgBKMTSNcd6156NtZ8-yTGBRR-FUgSA-TFlSuF1oP3zksX1H3ZfSJT_w0vgqv2OAOW3CGzBo" alt="User" class="rounded-circle" width="32" height="32" style="object-fit: cover;">
            <div>
                <div class="fw-bold" style="font-size: 0.85rem;">C. Rodríguez</div>
                <div class="text-secondary" style="font-size: 0.7rem;">Command Chief</div>
            </div>
        </div>
    </div>
</aside>
...
<header class="top-header border-bottom d-flex align-items-center justify-content-between px-4">
    <div class="d-flex align-items-center gap-4">
        ...
        <div class="position-relative">
            ...
            <input type="text" class="form-control form-control-sm ps-4 rounded-pill bg-light border-0" placeholder="Buscar incidentes o reportes..." style="width: 250px;">
        </div>
    </div>
    <div class="d-flex align-items-center gap-3">
