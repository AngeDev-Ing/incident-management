...
<head>
    ...
    <title>Digital Sentinel - Gestión de Cámaras</title>
...
<aside class="sidebar bg-dark text-white d-flex flex-column shadow">
    ...
    <ul class="nav nav-pills flex-column mb-auto px-3 gap-1">
        <li class="nav-item">
            <a href="/dashboard" class="nav-link text-white opacity-75 d-flex align-items-center gap-3">
        ...
        <li>
            <a href="/camaras" class="nav-link text-white active bg-primary bg-opacity-25 d-flex align-items-center gap-3">
                <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">videocam</span> Cámaras
            </a>
        </li>
    </ul>
    ...
    <div class="p-4 mt-auto border-top border-secondary">
        ...
        <a href="#" class="text-white text-decoration-none opacity-75 d-flex align-items-center gap-2 mb-4" style="font-size: 0.9rem;">
            <span class="material-symbols-outlined fs-6">settings</span> Configuración
        </a>
        
        <div class="d-flex align-items-center gap-3 bg-secondary bg-opacity-25 p-2 rounded">
            <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuAGVw1uo5kcCXXWuPaYubd70_o_5kIl3ANALNCiRe3GFzrdYroR9L5C6L8FTEWVUrDkCcTM2886T95e-jvtgf_J_F1bx0XIgBK3VUjy7QL-N8f-LpX7dQctsJeNj0xo7C4qXKw2GWFf3NIwmwM2l9lguHm7AN7RC1M9AYguYEHz45YsCxGC659wqKCSp4d_b1cqalvrMT89L4T0RxXpz0kUUa1hHQr0ntsiOPJvPQx3bKwKfG5HmZu43CETi8Hv6Cw5EA6SHV1XST_l" alt="User" class="rounded-circle" width="32" height="32" style="object-fit: cover;">
            <div>
                <div class="fw-bold" style="font-size: 0.85rem;">Cmdr. Marcus Vance</div>
                <div class="text-secondary" style="font-size: 0.7rem;">Chief Security Officer</div>
            </div>
        </div>
    </div>
</aside>
...
<header class="top-header border-bottom d-flex align-items-center justify-content-between px-4">
    <div class="d-flex align-items-center gap-4">
        <div class="d-md-none"><span class="material-symbols-outlined">menu</span></div>
        <h5 class="fw-bolder text-dark mb-0 d-none d-md-block font-headline">Digital Sentinel</h5>
        <div class="position-relative">
            ...
            <input type="text" class="form-control form-control-sm ps-4 rounded-pill bg-light border-0" placeholder="Buscar cámara o ID..." style="width: 250px;">
        </div>
    </div>
    <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="d-flex flex-column gap-3">
                        ...
                        <div class="card border-0 shadow-sm bg-white p-3 rounded-3 opacity-75">
                            ...
                            <div class="mt-2 d-flex gap-4 text-secondary" style="font-size: 0.75rem;">
                                ...
                                <div class="d-flex flex-column border-start ps-3">
                                    <small class="text-muted text-uppercase fw-bold" style="font-size: 0.6Offset;">Fin</small>
