    ...
    <div class="container-fluid max-w-7xl">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end gap-3 mb-4">
            <div>
                ...
                <p class="text-secondary mb-0" style="max-width: 600px;">Gestión y monitoreo en tiempo real de brechas de seguridad y anomalías detectadas por el sistema Digital Sentinel.</p>
            </div>
            <div class="d-flex gap-2">
                <button class="btn btn-outline-secondary btn-sm fw-semibold rounded-3 px-3 py-2">Exportar Reporte</button>
                <button class="btn btn-dark btn-sm primary-gradient border-0 fw-semibold rounded-3 px-3 py-2 d-flex align-items-center gap-2">
                    <span class="material-symbols-outlined fs-6">add</span> Nueva Incidencia
                </button>
            </div>
        </div>

        <!-- Dashboard Highlights (Asymmetric Bento) -->
            ...
            <div class="col-md-6">
                <div class="card border-0 shadow rounded-4 bg-dark text-white overflow-hidden h-100 position-relative primary-gradient">
                    <div class="card-body p-4 d-flex flex-column justify-content-between position-relative z-1">
                        <div>
                            <span class="text-light fw-bold text-uppercase d-block mb-1" style="font-size: 0.65rem; letter-spacing: 1px;">Tiempo Medio de Respuesta</span>
                            <span class="fs-2 fw-bold">4.2 min</span>
                        </div>
                        <p class="text-light opacity-25 font-monospace mb-0 mt-3" style="font-size: 0.6rem;">SENTINEL_KPI_SYSTEM_STABLE</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
            <div class="card-header bg-light border-0 py-3 d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-link text-secondary text-decoration-none fw-semibold d-flex align-items-center gap-1 p-0 fs-7">
                    <span class="material-symbols-outlined fs-6">filter_list</span> Filtros Avanzados
                </button>
            </div>
